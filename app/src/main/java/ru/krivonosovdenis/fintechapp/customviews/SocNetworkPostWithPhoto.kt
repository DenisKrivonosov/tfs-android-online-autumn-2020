...
import kotlinx.android.synthetic.main.post_with_photo.view.postActionLike
import kotlinx.android.synthetic.main.post_with_photo.view.postActionsDivider
import kotlinx.android.synthetic.main.post_with_photo.view.postDate
import kotlinx.android.synthetic.main.post_with_photo.view.postImage
import kotlinx.android.synthetic.main.post_with_photo.view.postLikesCounter
import kotlinx.android.synthetic.main.post_with_photo.view.postText
import kotlinx.android.synthetic.main.post_with_photo.view.posterAvatar
import kotlinx.android.synthetic.main.post_with_photo.view.posterName
...
class SocNetworkPostWithPhoto @JvmOverloads constructor(
    ...
    override fun onLayout(changed: Boolean, l: Int, t: Int, r: Int, b: Int) {
        ...
        val postActionCommentRightCoordinate =
            postActionCommentLeftCoordinate + postActionComment.measuredWidth
        val postActionCommentBottomCoordinate =
            postActionCommentTopCoordinate + postActionComment.measuredHeight
        postActionComment.layout(
            postActionCommentLeftCoordinate,
            postActionCommentTopCoordinate,
            postActionCommentRightCoordinate,
            postActionCommentBottomCoordinate
        )
